...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    threshold_val = 10/100*threshold
    threshold_low = threshold - threshold_val
    threshold_high = threshold + threshold_val
    if value < (90/100*threshold):
        return 'LOW'
    elif threshold_high >= value >= threshold_low:
        return 'NORMAL'
    else :
        return 'DANGER'
